...
fn migrations_create_operational_lifecycle_paper_wallet_safety_and_fast_lane_tables() {
    ...
    for table in [
        ...
        "fast_events",
        "pump_trade_execution_economics",
    ...
    for index in [
        ...
        "idx_pump_swap_trade_evidence_pool_time",
        "idx_pump_swap_trade_evidence_observed",
        "idx_pump_trade_evidence_conflicts_identity",
        "idx_pump_trade_evidence_conflicts_observed",
        "idx_pump_swap_trade_evidence_conflicts_identity",
        ...
        "idx_fast_future_path_labels_decision_sequence",
...
fn reopening_database_does_not_reapply_migrations() {
    ...
    assert_eq!(reopened.diagnostics().unwrap().schema_version, 16);
    drop(reopened);

    let connection = Connection::open(&db_path).unwrap();
    for version in [
        1_i64, 2_i64, 3_i64, 4_i64, 5_i64, 6_i64, 7_i64, 8_i64, 9_i64, 10_i64, 11_i64,
        12_i64, 13_i64, 14_i64, 15_i64, 16_i64,
    ] {
        let count: i64 = connection
            .query_row(
...
fn schema_nine_upgrade_preserves_existing_e14_candidate_and_exit_quote_evidence() {
    ...
    assert_eq!(upgraded.diagnostics().unwrap().schema_version, 16);
    drop(upgraded);
    ...
    for version in [
        8_i64, 9_i64, 10_i64, 11_i64, 12_i64, 13_i64, 14_i64, 15_i64, 16_i64,
    ] {
        let count: i64 = connection
            .query_row(
                "SELECT COUNT(*) FROM schema_migrations WHERE version = ?1",
